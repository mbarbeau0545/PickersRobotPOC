...
t_eAPPSNS_SensorState g_snsState_ae[APPSNS_SENSOR_NB] = {
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_DIAG_MOTOR_X_LEFT
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_DIAG_MOTOR_X_RIGHT
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_DIAG_MOTOR_Y
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_DIAG_MOTOR_Z
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_X_LEFT_MIN
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_X_LEFT_MAX
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_X_RIGHT_MIN
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_X_RIGHT_MAX
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_Y_MIN
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_Y_MAX
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_Z_MIN
    APPSNS_SENSOR_STATE_ENABLE, // APPSNS_SENSOR_LIMIT_SWITCH_Z_MAX
};
