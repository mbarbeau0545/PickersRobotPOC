...
t_eAPPACT_ActuatorState g_actState_ae[APPACT_ACTUATOR_NB] = {
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_X_LEFT_STATE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_X_LEFT_DIR
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_X_LEFT_PULSE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_X_RIGHT_STATE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_X_RIGHT_DIR
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_X_RIGHT_PULSE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_Y_STATE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_Y_DIR
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_Y_PULSE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_Z_STATE
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_Z_DIR
    APPACT_ACTUATOR_STATE_ENABLE, // APPACT_ACTUATOR_MOTOR_AXE_Z_PULSE
};
