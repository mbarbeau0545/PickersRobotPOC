...
// *                      Variables
// ********************************************************************
static const t_eCL42T_MotorId c_MotorId_e = CL42T_MOTOR_3;
//********************************************************************************
//                      Local functions - Prototypes
//********************************************************************************
static void MtrY_MotorDiagnostic(t_eCL42T_MotorId f_MotorID_e, t_eCL42T_DiagError f_DefeultInfo_e);
//****************************************************************************
...
******************************************/
t_eReturnCode APPACT_SPEC_Mtr_Y_SetCfg(void)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for Mtr_Y_SetActCfg here
    ...
    t_sCL42T_MotorSigCfg MotorConfig_s = {
        ...
        .StateSigCfg = {
            .DigitalSignal_e = FMKIO_OUTPUT_SIGDIG_7, 
            .PullMode_e = FMKIO_PULL_MODE_DISABLE,
        },
        .DirSigCfg_s = {
            .DigitalSignal_e = FMKIO_OUTPUT_SIGDIG_11, 
            .PullMode_e = FMKIO_PULL_MODE_DISABLE,
        },
        .DiagSigCfg_s = {
...
/******************************************
* APPACT_SPEC_Mtr_Y_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_Mtr_Y_GetValue(t_uAPPACT_GetValue *f_value_pu)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for Mtr_Y_GetActValue here
...
/******************************************
* APPACT_SPEC_Mtr_Y_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_Mtr_Y_SetValue(t_uAPPACT_SetValue f_value_u)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for Mtr_Y_SetActValue here
