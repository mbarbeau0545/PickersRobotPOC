...
#ifndef APPACT_SPEC_MOTOR_AXE_X_LEFT_DIR
#define APPACT_SPEC_MOTOR_AXE_X_LEFT_DIR
/* CAUTION : Automatic generated code section for ifndef: End */
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_Motor_Axe_X_Left_Dir_SetCfg(void);
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_Motor_Axe_X_Left_Dir_GetValue(t_sAPPACT_ValueInfo *f_value_ps);
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_Motor_Axe_X_Left_Dir_SetValue(t_sint16 f_value_s16);
