...
// *                      Variables
// ********************************************************************
static const t_eCL42T_MotorId c_MotorId_e = CL42T_MOTOR_2;
//********************************************************************************
//                      Local functions - Prototypes
//********************************************************************************
static void MtrX_R_MotorDiagnostic(t_eCL42T_MotorId f_MotorID_e, t_eCL42T_DiagError f_DefeultInfo_e);
//****************************************************************************
...
/******************************************
* APPACT_SPEC_Mtr_X_R_SetCfg
******************************************/
t_eReturnCode APPACT_SPEC_Mtr_X_R_SetCfg(void)
{
    ...
    t_sCL42T_MotorSigCfg MotorConfig_s = {
        ...
        .DirSigCfg_s = {
            .DigitalSignal_e = FMKIO_OUTPUT_SIGDIG_3,
            .PullMode_e = FMKIO_PULL_MODE_DISABLE,
        },
        .DiagSigCfg_s = {
...
/******************************************
* APPACT_SPEC_Mtr_X_R_GetValue
******************************************/
t_eReturnCode APPACT_SPEC_Mtr_X_R_GetValue(t_uAPPACT_GetValue *f_value_pu)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for Mtr_X_R_GetActValue here
...
/******************************************
* APPACT_SPEC_Mtr_X_R_SetValue
******************************************/
t_eReturnCode APPACT_SPEC_Mtr_X_R_SetValue(t_uAPPACT_SetValue f_value_u)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for Mtr_X_R_SetActValue here
...
static void MtrX_R_MotorDiagnostic(t_eCL42T_MotorId f_MotorID_e, t_eCL42T_DiagError f_DefeultInfo_e)
{
    ...
    if(Ret_e == RC_OK)
    {
        switch (f_DefeultInfo_e)
        {
            ...
            {
                Ret_e = APPSDM_ReportDiagEvnt(  APPSDM_DIAG_ITEM_GTRY_AXE_X_ERR,
