...
#ifndef APPACT_SPEC_MTR_X_L_STATE
#define APPACT_SPEC_MTR_X_L_STATE
/* CAUTION : Automatic generated code section for ifndef: End */
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_Mtr_X_L_State_SetCfg(void);
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_Mtr_X_L_State_GetValue(t_sAPPACT_ValueInfo *f_value_ps);
    ...
    *
    */
    t_eReturnCode APPACT_SPEC_Mtr_X_L_State_SetValue(t_sint16 f_value_s16);
