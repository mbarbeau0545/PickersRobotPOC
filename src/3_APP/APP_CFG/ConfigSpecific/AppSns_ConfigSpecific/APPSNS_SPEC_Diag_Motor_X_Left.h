...
#ifndef APPSNS_SPEC_DIAG_MOTOR_X_LEFT
#define APPSNS_SPEC_DIAG_MOTOR_X_LEFT
/* CAUTION : Automatic generated code section for ifndef: End */
    ...
    *
    */
    t_eReturnCode APPSNS_SPEC_Diag_Motor_X_Left_SetCfg(void);
    ...
    *
    */
    t_eReturnCode APPSNS_SPEC_Diag_Motor_X_Left_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * isValueOK_b);
    ...
    *
    */
    t_eReturnCode APPSNS_SPEC_Diag_Motor_X_Left_FormatValue(t_float32  rawValue_f32, t_float32 *SnsValue_f32);
