...
#ifndef APPSNS_SPEC_LIM_SWCH_Y_MAX
#define APPSNS_SPEC_LIM_SWCH_Y_MAX
/* CAUTION : Automatic generated code section for ifndef: End */
    ...
    *
    */
    t_eReturnCode APPSNS_SPEC_Lim_Swch_Y_Max_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * isValueOK_b);
