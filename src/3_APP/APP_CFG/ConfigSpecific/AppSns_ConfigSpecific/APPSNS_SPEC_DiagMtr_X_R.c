...
#include "./APPSNS_SPEC_DiagMtr_X_R.h"
...
/******************************************
* APPSNS_SPEC_DiagMtr_X_R_SetCfg
******************************************/
t_eReturnCode APPSNS_SPEC_DiagMtr_X_R_SetCfg(void)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for DiagMtr_X_R_SetSnsCfg here
...
/******************************************
* APPSNS_SPEC_DiagMtr_X_R_GetSigValue
******************************************/
t_eReturnCode APPSNS_SPEC_DiagMtr_X_R_GetSigValue(t_float32 *f_rawSigValue_pf32, t_bool * f_isValue_OK)
{
    t_eReturnCode Ret_e = RC_OK;
    //    Your code for DiagMtr_X_R_GetSigValue here
