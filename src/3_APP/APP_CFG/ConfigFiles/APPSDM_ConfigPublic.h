...
#define APPSDM_CONFIGPUBLIC_H_INCLUDED
    ...
    */
    typedef enum ____t_eAPPSDM_DiagnosticItem
    {
        ...
        APPSDM_DIAG_ITEM_GTRY_AXE_X_ERR,// None
        APPSDM_DIAG_ITEM_GTRY_AXE_Y_ERR,// None
        APPSDM_DIAG_ITEM_GTRY_AXE_Z_ERR,// None
        ...
        APPSDM_DIAG_ITEM_APPUSER_COM_CHECKSUM_FAILED,// None
