...
#define FMKIO_CONFIGPRIVATE_H_INCLUDED
    ...
    const t_sFMKIO_BspTimerSigCfg c_OutPwmSigBspMap_as[FMKIO_OUTPUT_SIGPWM_NB] = {
        //GPIO_name                     Pin_name                      alternate function timer      Timer                         Timer_channel                 bsp pin name                  
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_6},              GPIO_AF0_MCO,                  FMKCPU_TIMER_3,               FMKCPU_CHANNEL_1},    // FMKIO_OUTPUT_SIGPWM_1,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_7},              GPIO_AF0_MCO,                  FMKCPU_TIMER_3,               FMKCPU_CHANNEL_2},    // FMKIO_OUTPUT_SIGPWM_2,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_8},              GPIO_AF0_MCO,                  FMKCPU_TIMER_3,               FMKCPU_CHANNEL_3},    // FMKIO_OUTPUT_SIGPWM_3,
        {{FMKIO_GPIO_PORT_C,             FMKIO_GPIO_PIN_9},              GPIO_AF0_MCO,                  FMKCPU_TIMER_3,               FMKCPU_CHANNEL_4},    // FMKIO_OUTPUT_SIGPWM_4,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_8},              GPIO_AF0_MCO,                  FMKCPU_TIMER_1,               FMKCPU_CHANNEL_1},    // FMKIO_OUTPUT_SIGPWM_5,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_9},              GPIO_AF0_MCO,                  FMKCPU_TIMER_1,               FMKCPU_CHANNEL_2},    // FMKIO_OUTPUT_SIGPWM_6,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_10},             GPIO_AF0_MCO,                  FMKCPU_TIMER_1,               FMKCPU_CHANNEL_3},    // FMKIO_OUTPUT_SIGPWM_7,
        {{FMKIO_GPIO_PORT_A,             FMKIO_GPIO_PIN_11},             GPIO_AF0_MCO,                  FMKCPU_TIMER_1,               FMKCPU_CHANNEL_4},    // FMKIO_OUTPUT_SIGPWM_8,
    };
